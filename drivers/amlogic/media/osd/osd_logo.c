...
int set_osd_logo_freescaler(void)
{
	...
	pr_info("set_osd_logo_freescaler 5 start src_x_start: %d, logo_info.fb_width: %d, src_y_start: %d, logo_info.fb_height: %d, dst_x_start: %d, target_x_end: %d, dst_y_start: %d, target_y_end:%d\n",
		src_x_start, logo_info.fb_width - 1, src_y_start, logo_info.fb_height -1, dst_x_start, target_x_end, dst_y_start, target_y_end);
	if ((src_x_start == 0)
